...
public abstract class AbstractList implements ListInterface  {
    ...
    */
    ...
    /**
     * sets the list with given int array.
     * @param list1 .
     */
    public void setList(final int[] list1) {
        this.list = list1;
    }
    /**
     * @return returns the number of elements of array.
     */
    public int getSize() {
        return size;
    }
    /**
     * to set size of the list.
     * @param size1 .
     */
     ...
     * So, you will be having a gap at the given index where you can
     *  insert a new element / item
     ...
     * This method throws an exception IndexOutOfBoundsException
     *  with a message
     * if index < 0 or index > size with a message
     *  "Invalid index to add element"
     * @param index .
     * @param item .
    ...
    public void add(final int index, final int item)
        ...
        if (OrderedList.class.isInstance(this)) {
            throw new UnsupportedOperationException(
                "Can't call this method on OrderedList"
                );
        }
        // TODO
        // your code goes here
    ...
    /**
     * Appends all of the elements in the specified list to the
     * end of this list, or
     ...
     */
    public int get(final int index) throws InvalidIndexException {
        // TODO
        // your code goes here
    ...
    public List subList(final int fromIndex, final int toIndex)
        ...
        int[] newArr = new int[subListSize];
        for (int i = fromIndex, j = 0; i < toIndex; i++, j++) {
            newArr[j] = list[i];
        }
        newList.addAll(newArr);
        return newList;
    }
